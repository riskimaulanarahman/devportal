var modname = 'memorandum_approver';
...
const popupContentTemplate = function (reqid,mode,options) {
    ...
    var isPendingOnMe = options.data.isPendingOnMe;
    popupid = reqid;
    reqStatusMaster = options.data.requestStatus;
                ...
                if(data.ID == 1) {
                    ...
                    let formData = $("<div id='formdata'>").dxDataGrid({    
                        ...
                        onEditorPreparing: function (e) {        
                            if ((e.dataField == "additional_approver") && e.parentType == "dataRow") {
                        ...
                        columns: [
                            {
                                ...
                                visible: (reqStatusMaster == 3 || reqStatusMaster == 4) ? true : false
                            },
                            {
                                caption: 'code',
                                dataField: 'code_id',
