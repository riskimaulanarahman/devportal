        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul>
                    ...
                    <li class="mb-1"><button class="btn btn-primary" onclick="window.open('{{ env('APP_URL') }}/public/upload/panduan/GHM.pdf', '_blank')">Guesthouse & Mess Booking System</button></li>
                </ul>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
