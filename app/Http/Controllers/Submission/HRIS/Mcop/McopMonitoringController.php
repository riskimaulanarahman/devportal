...
class McopMonitoringController extends Controller
{
    ...
    public function importCsv(Request $request)
    {
        ...
        // Baca file CSV dan konversi ke UTF-8 jika perlu
        // $csvContent = file_get_contents($path);
        // $csvContent = mb_convert_encoding($csvContent, 'UTF-8', 'auto'); // Konversi ke UTF-8

        // Simpan konten yang sudah dikonversi ke file sementara
